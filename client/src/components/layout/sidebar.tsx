...
const navigation = [
  { name: "Speech Practice", href: "/", icon: BarChart3 },
      ...
      <aside className={cn(
        ...
        <div className="p-6 border-b border-gray-200">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="font-bold text-lg text-gray-900">SpeechPractice</h1>
              <p className="text-sm text-gray-500">AI-Powered Speaking Coach</p>
            </div>
          </div>
        </div>
